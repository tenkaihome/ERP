      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center space-y-4 mb-16">
          ...
          <h2 className="text-3xl font-extrabold text-zinc-900 dark:text-white sm:text-4xl">
            Các Câu Hỏi Thường Gặp Về Chi Phí ERP
          </h2>
          <p className="text-base text-zinc-600 dark:text-zinc-400">
            Làm rõ các hiểu lầm và điểm mập mờ trong báo giá phần mềm và triển khai dự án ERP.
          </p>
        </div>
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="w-full flex items-center justify-between p-5 text-left font-semibold text-zinc-850 dark:text-zinc-100 hover:bg-zinc-50/50 dark:hover:bg-zinc-800/30 gap-4 transition-colors"
                >
